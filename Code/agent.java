...
class agent extends JFrame implements ActionListener,KeyListener
{
        ...
        agent()
        {
                ...
                l=new JLabel("AGENT INFORMATION");
                l.setFont(f2);
                l.setForeground(Color.white);
                l.setBounds(180,30,800,40);
        p.add(l);
                
                l1=new JLabel("AgentID:");
                l1.setFont(f1);
                l1.setForeground(Color.white);
                l1.setBounds(30,94,80,40);
        p.add(l1);        
                
                t1=new JTextField(5);
                t1.setBounds(140,94,40,30);
        p.add(t1);        
                
                l2=new JLabel("AName:");
                l2.setFont(f1);
                l2.setForeground(Color.white);
                l2.setBounds(30,155,80,40);
        p.add(l2);        
                
                t2=new JTextField(20);
                t2.addKeyListener(this);
                t2.setBounds(140,155,150,30);
        p.add(t2);        
                
                l3=new JLabel("Address:");
                l3.setFont(f1);
                l3.setForeground(Color.white);
                l3.setBounds(30,225,70,40);
        p.add(l3);        
                
                ta=new JTextArea(50,90);
                ta.addKeyListener(this);
                ta.setBounds(140,225,180,60);
        p.add(ta);        
                
                l4=new JLabel("Area:");
                l4.setFont(f1);
                l4.setForeground(Color.white);
                l4.setBounds(30,321,70,40);
        p.add(l4);        
                
                t4=new JTextField(15);
                t4.addKeyListener(this);
                t4.setBounds(140,321,150,30);
        p.add(t4);        
                
                l5=new JLabel("MobileNo:");
                l5.setFont(f1);
                l5.setForeground(Color.white);
                l5.setBounds(30,382,70,30);
       p.add(l5);         
       ...
       p.add(t5); 
       			...
       			l6=new JLabel("DATE:");//system date
          		l6.setFont(f1);
                l6.setForeground(Color.white);
                l6.setBounds(480,74,60,40);
          p.add(l6); 
          		
                l7=new JLabel();
                l7.setBounds(550,77,70,30);
        p.add(l7);l7.setForeground(Color.white);               
       ...
       p.add(b8);b8.setIcon(first);         
		...
		p.add(b11);b11.setIcon(exit);
                ...
                b12.setBounds(520,520,120,50);
                b12.setMnemonic('H');
                b12.setToolTipText("Goes To HOMESCREEN");
                b12.addActionListener(this);
		p.add(b12);b12.setIcon(home);
		
				ImageIcon agent=new ImageIcon("agents.png");
        		l8=new JLabel(agent);
        		l8.setBounds(380,160,280,260);
        		l8.setToolTipText("AGENT WINDOW");
        	p.add(l8);
        ...
        try
     	{
            ...
            rs1=st1.executeQuery("Select * from agent");
         ...
         public void actionPerformed(ActionEvent a1)
         {
        		...
        		else if(a1.getSource()==b9)//last
               {
                ...
                else if(a1.getSource()==b4)//Save
                {
                  try
                  {
                    ps=cn1.prepareStatement("insert into agent values(?,?,?,?,?)");
        		...
        		else if(a1.getSource()==b2)//modify
                {
                  try
                  {
                    ps=cn1.prepareStatement("update agent set AgentID=?,agentname=?,agentaddr=?,area=?,mobile=? where AgentID=?");
                    ps.setInt(1,Integer.parseInt(t1.getText()));
                    ps.setString(2,t2.getText().toLowerCase());
                    ps.setString(3,ta.getText().toLowerCase());
                    ps.setString(4,t4.getText().toLowerCase());
        		...
        		else if(a1.getSource()==b3)//delete
                {
  					try
        			{
        					...
        					ps2=cn1.prepareStatement("delete * from agent where AgentID="+pid);
         					ps2.executeUpdate();
         					cn1.commit();
         					clearall();
					...
					try
		 			{
                		...
                		if(str!=null)                                
            			{
                    		...
                    		rs3 = st3.executeQuery("select * from agent where agentname='"+str+"'");
